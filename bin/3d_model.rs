...
fn main() {
    ...
    let model_build2 = ModelComponent::builder().load_model(Path::new("resources/flat_vase.obj"));
    ...
    cube_transform.translation = nalgebra::Vector3::<f32>::new(0.25, 0.25, 0.0);
    let mut cube_transform2 = TransformComponent::default();
    cube_transform2.translation = nalgebra::Vector3::<f32>::new(-0.25, 0.25, 0.0);
    ...
    world.add_component_to_entity(entity2, model_build2);
    world.add_component_to_entity(entity2, cube_transform2);
