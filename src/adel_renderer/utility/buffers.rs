...
impl AshBuffers {
    pub fn new(
        ...
        let command_pool = AshBuffers::create_command_pool(
            &device,
        ...
        let transient_command_pool = AshBuffers::create_command_pool(
            &device,
            &context.queue_family,
        ...
        /*
            Uniform Buffers and Descriptor Pool Could be moved
        */
    ...
    */
    ...
    pub fn create_descriptor_sets_self(
        &self,
        device: &ash::Device,
        descriptor_set_layout: vk::DescriptorSetLayout,
        texture_image_view: vk::ImageView,
        ...
        AshBuffers::create_descriptor_sets(
            device,
